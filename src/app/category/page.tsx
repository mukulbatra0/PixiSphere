    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-2xl font-bold text-black">Maternity Photographers in Bengaluru</h1>
        </div>
      </header>
          ...
          <div className="md:w-3/4 lg:w-4/5">
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-lg font-medium text-black">No photographers found</h3>
                <p className="mt-1 text-sm text-black">Try adjusting your filters or search query.</p>
              </div>
            )}
          </div>
        </div>
